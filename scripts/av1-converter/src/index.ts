...
async function convertFile(
  ...
  if (argv["apply-smoothing"]) {
    const smoothingChain = "deblock=filter=strong:block=8:alpha=0.1:beta=0.08:gamma=0.07:delta=0.06,hqdn3d=luma_spatial=4:chroma_spatial=3,deband=range=16:dither=1";
